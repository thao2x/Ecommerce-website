        ...
        <div class="card recent-sales overflow-auto">
            <div class="card-body p-3">
                ...
                <div class="d-flex  justify-content-end">
                    <a href="{{ route('products.index') }}" class="btn btn-outline-secondary me-2">Quay lại</a>
                    <a href="{{ route('products.destroy', $product->id) }}" class="btn btn-outline-danger me-2">Xóa sản phẩm</a>
